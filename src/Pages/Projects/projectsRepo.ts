...
[
    ...
    {__id:"5",title:"Javascript Riddle",link:"",picUrl:riddlePic,vidurl:riddlevid,desc:"This riddle is made in javascript. To solve the riddle one must transfer all the objects from one side of the river to the other. In this project I learned a lot about javascript."},
